 ...
 * 3. openspec 是否为包装脚本
 * 4. openspec/changes.json 是否有效 JSON
        ...
        if (regCheck.valid) {
            ...
            results.push({
                ...
                fix: regCheck.error === 'not found'
                    ? '在项目根目录创建 openspec/changes.json 或运行 openspec-superpowers-opencode init'
